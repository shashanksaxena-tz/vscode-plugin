...
import { getCohortMembers, getAvailableUsers } from '@/app/actions/cohorts';
...
describe('CohortList', () => {
  ...
  it('opens modal to edit cohort', async () => {
    render(<CohortList cohorts={mockCohorts} />);
  ...
  it('opens modal to view cohort when name is clicked', async () => {
    render(<CohortList cohorts={mockCohorts} />);
