        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow overflow-y-auto max-h-[420px]">
              <h2 className="text-xl font-semibold mb-6">Latest Insights & Coaching</h2>
              {latestScore.insights || latestScore.suggestions ? (
                <div className="space-y-6">
                  {latestScore.insights && (
                    <div>
                      <h3 className="text-lg font-medium text-gray-800 mb-3">Insights</h3>
                      <InsightsList insights={latestScore.insights as any} />
                    </div>
                  )}
                  {latestScore.suggestions && (
                    <div>
                      <h3 className="text-lg font-medium text-gray-800 mb-3">Coaching Suggestions</h3>
