...
export default async function TeamDashboardPage() {
  ...
  try {
    ...
    if (usersData && usersData.length > 0) {
      ...
      const { data: cohortDataResponse, error: cohortError } = await supabase
        .from("cohort_members")
      ...
      const cohortData = cohortDataResponse as unknown as CohortMemberData[] | null;
